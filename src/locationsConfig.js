...
export const LOCATION_MODULE_GROUPS = {
  field_er_kit1: [
    ...
    { moduleKey: 'medicine_bag_external', label: 'กระเป๋ายา · ยาใช้ภายนอก', accent: '#1D9A63' },
    { moduleKey: 'medicine_bag_injectable', label: 'กระเป๋ายา · ยาฉีด', accent: '#B8760A' },
    { moduleKey: 'medicine_bag_highAlert', label: 'กระเป๋ายา · ยา High Alert Drug', accent: '#D64545', warn: true },
    { moduleKey: 'medicine_bag_fluids', label: 'กระเป๋ายา · น้ำเกลือและเวชภัณฑ์' },
    { moduleKey: 'medicine_bag_supplies', label: 'กระเป๋ายา · อุปกรณ์ให้สารน้ำและทำแผล' },
    { moduleKey: 'medicine_bag_instruments', label: 'กระเป๋ายา · เครื่องมือตรวจร่างกายและอุปกรณ์อื่นๆ' },
    { moduleKey: 'field_emergency_bag_front', label: 'กระเป๋าฉุกเฉิน · กระเป๋าช่องหน้า' },
    { moduleKey: 'field_emergency_bag_largePocket', label: 'กระเป๋าฉุกเฉิน · กระเป๋าช่องใหญ่' },
    { moduleKey: 'field_emergency_bag_sides', label: 'กระเป๋าฉุกเฉิน · กระเป๋าด้านข้าง 2 ข้าง' },
    { moduleKey: 'field_emergency_bag_topSmall', label: 'กระเป๋าฉุกเฉิน · กระเป๋าเล็กด้านบน' },
    { moduleKey: 'field_emergency_bag_blueSmall', label: 'กระเป๋าฉุกเฉิน · กระเป๋าเล็กสีน้ำเงิน' },
    ...
    { moduleKey: 'pediatric_bag_syrup', label: 'กระเป๋ายาเด็ก · ยาน้ำเด็ก' },
    { moduleKey: 'pediatric_bag_supplies', label: 'กระเป๋ายาเด็ก · อุปกรณ์และของใช้' },
  ],
  field_er_kit2: [
    { moduleKey: 'medicine_bag_oral', label: 'กระเป๋ายา · ยารับประทาน', accent: '#1D9A63' },
    { moduleKey: 'medicine_bag_external', label: 'กระเป๋ายา · ยาใช้ภายนอก', accent: '#1D9A63' },
...
export const CATEGORY_META = {
  ...
  FIELD_BAG: { num: '2', label: 'กระเป๋าออกตรวจฉุกเฉิน', subtitle: 'ER · CONC.G · Sat-1', order: 2 },
