                ...
                <div className="checklist-content">
                 ...
                 {it.has_expiry && (
                    <>
                      ...
                      <div className="med-row">
                        <input type="number" className="text-input" style={{ fontSize: 22, fontWeight: 700, textAlign: 'center' }} placeholder={it.standard_qty ? `มาตรฐาน ${it.standard_qty}` : 'จำนวน'} value={a.amount || ''} onChange={(e) => setAnswer(it.id, { amount: e.target.value })} />
